var queryURL =
  "https://www.googleapis.com/customsearch/v1?key=AIzaSyBi9TqdUF6VKPljkqLDhzvl6U8pX52o3Os&cx=006380461912858690956:ji5obu7szxk&q=pain_management+pain+knee_pain+back_pain+chronic_pain";
...
$.ajax({
  ...
  for (var a = 0; a < response.items.length; a++) {
    ...
    $(".article-container")
      .append(`<div class="container results" id="${artResults.id}">
