...
var access_token = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyMkI2MlQiLCJzdWIiOiI3VDIzMjkiLCJpc3MiOiJGaXRiaXQiLCJ0eXAiOiJhY2Nlc3NfdG9rZW4iLCJzY29wZXMiOiJ3aHIgd3BybyB3bnV0IHdzbGUgd3dlaSB3c29jIHdhY3Qgd3NldCB3bG9jIiwiZXhwIjoxNTcxNDE5MjE2LCJpYXQiOjE1NzA4OTA4MTZ9.mubIeZA6bdh6Q834LH84enZEQYvCOHYNDYCrkzWtqIw';
...
xhr.onload = function () {
    if (xhr.status === 200) {
        ...
        $(".patient-home-pain").append(`
        <div>${result['activities-heart']}</div>`);
